...
LteEnbRrc::LteEnbRrc ()
  : m_x2SapProvider (0),
    ...
    m_allowAutonomousHoWithE2 (false) // 진섭
...
LteEnbRrc::DoUpdateUeSinrEstimate(LteEnbCphySapUser::UeAssociatedSinrInfo info)
{
  ...
  NS_LOG_DEBUG ("CC " << (uint16_t)info.componentCarrierId << " reports the ueImsiSinrMap");
                      ...
                      // (this is done when an X2 interface among mmWave eNBs and LTE eNB is added)
  {
    ...
    NS_LOG_DEBUG("number of SINR reported " << params.ueImsiSinrMap.size());
